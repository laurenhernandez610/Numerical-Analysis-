 ...
 TRUE = 1;
 FALSE = 0;
 fprintf(1,'This is Modified Eulers Method.\n');
 ...
 fprintf(OUP, 'Modified Eulers Method\n\n');
...
% STEP 4
 ...
 if OKS==TRUE
  ...
  if  OKS==TRUE
    plot(xx,AP,'*-'); hold on;
    plot(xxp,yyp,'r-');
    legend('Modified Euler Method','Exact solution', 'Location','NorthWest');
%     plot(xx,yy,'r-');
  else
    plot(xx,AP,'*-'); hold on;
    legend('Modified Euler Method','Location','NorthWest');
  end;
%     plot(xx,AP,'b-'); 
